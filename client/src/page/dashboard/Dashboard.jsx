...
const Dashboard = () => {
  ...
  const handleUpdateModelOpen = (employee) => {
                  ...
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((emp, index) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-4">
                          <button
                            onClick={() => handleUpdateModelOpen(emp)}
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="px-6 py-6 space-y-3">
              {[
                ...
                {
                  icon: <CircleDot size={15} className="text-gray-400" />,
                  label: "Status",
            ...
            <form onSubmit={handleUpdateEmployee} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-4 py-3 mt-1 outline-none focus:border-emerald-500"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-emerald-600 hover:bg-emerald-700 transition-colors text-white py-3 rounded-xl font-semibold"
              >
                Update Employee
              </button>
            </form>
